package com.seowang.mynewstruct.net.async;

import android.graphics.Bitmap;
import android.os.Message;

import com.seowang.mynewstruct.net.cache.ImageCacheUtil;
import com.seowang.mynewstruct.net.cache.JsonCacheUtil;
