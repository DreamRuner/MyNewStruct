...
//        return Environment.getExternalStorageDirectory().getFreeSpace();
    ...
    public static String formatBytes(long byteSizes){
        ...
        return Formatter.formatFileSize(BaseApplication.getMainContext(),byteSizes);
    }
...
//        Environment.getExternalStorageDirectory().
    ...
    public static File getFileByLongStorge(){
        ...
        return BaseApplication.getMainContext().getFilesDir();
    }
    ...
    public static String getPathByLongStorge(){
        ...
        return BaseApplication.getMainContext().getFilesDir().getAbsolutePath()+"/";
    }
    ...
    public static File getFileBycache(){
        ...
        return BaseApplication.getMainContext().getCacheDir();
    }
    ...
    public static String getPathBycache(){
        return BaseApplication.getMainContext().getCacheDir().getPath()+"/";
    }
